import { Banknote, Users, Package as PackageIcon, Calendar } from 'lucide-react'
...
export function AdminStatsGrid({ totalRevenue, bookingsCount, totalPilgrims, activePackages }: Props) {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      <StatCard label="মোট আয়" value={formatCurrency(totalRevenue)} delta={{ value: '24%', positive: true }} icon={<Banknote className="w-5 h-5" />} index={0} />
