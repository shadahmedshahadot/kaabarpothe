...
async function main() {
  ...
  // 14. SEO defaults (idempotent — upsert)
  await seedSEODefaults()

  console.log('✅ Seed complete.')
}

// ---------- SEO seeding (idempotent, safe to re-run) ----------
...
const STATIC_PAGES = [
  { pageKey: 'home', pagePath: '/', pageName: 'Home', title: 'কাবার পথে | পবিত্র হজ ও উমরাহ যাত্রা', metaDescription: 'বিশ্বস্ত হজ ও উমরাহ প্যাকেজ, পবিত্র ভ্রমণ পরিকল্পনা ও পরিপূর্ণ সেবা।', keywords: ['হজ', 'উমরাহ', 'পবিত্র যাত্রা'] },
  { pageKey: 'about', pagePath: '/about', pageName: 'About', title: 'আমাদের সম্পর্কে | কাবার পথে', metaDescription: 'আমাদের মিশন, দর্শন ও অভিজ্ঞ দল সম্পর্কে জানুন।', keywords: [] },
  { pageKey: 'contact', pagePath: '/contact', pageName: 'Contact', title: 'যোগাযোগ | কাবার পথে', metaDescription: 'আপনার প্রশ্ন বা বুকিং নিয়ে আমাদের সাথে যোগাযোগ করুন।', keywords: [] },
  { pageKey: 'faq', pagePath: '/faq', pageName: 'FAQ', title: 'সচরাচর জিজ্ঞাসা | কাবার পথে', metaDescription: 'হজ ও উমরাহ যাত্রা সম্পর্কে গুরুত্বপূর্ণ প্রশ্ন ও উত্তর।', keywords: [] },
  { pageKey: 'reviews', pagePath: '/reviews', pageName: 'Reviews', title: 'পিলগ্রিমদের প্রতিক্রিয়া | কাবার পথে', metaDescription: 'আমাদের যাত্রীদের প্রকৃত অভিজ্ঞতা ও রিভিউ পড়ুন।', keywords: [] },
  { pageKey: 'packages-hajj', pagePath: '/packages/hajj', pageName: 'Hajj Packages', title: 'হজ প্যাকেজ | কাবার পথে', metaDescription: 'বাজেট থেকে লাক্সারি পর্যন্ত সমস্ত হজ প্যাকেজ ব্রাউজ করুন।', keywords: ['হজ প্যাকেজ', 'হজ ২০২৬'] },
  { pageKey: 'packages-umrah', pagePath: '/packages/umrah', pageName: 'Umrah Packages', title: 'উমরাহ প্যাকেজ | কাবার পথে', metaDescription: 'সারা বছর ধরে বিভিন্ন উমরাহ প্যাকেজ।', keywords: ['উমরাহ প্যাকেজ'] },
  { pageKey: 'transportation', pagePath: '/transportation', pageName: 'Transportation', title: 'পরিবহন সেবা | কাবার পথে', metaDescription: 'বিমানবন্দর ট্রান্সফার, আন্তঃশহর ও জিয়ারত ভ্রমণের জন্য বিশ্বস্ত পরিবহন সেবা।', keywords: [] },
  { pageKey: 'privacy', pagePath: '/privacy', pageName: 'Privacy Policy', title: 'গোপনীয়তা নীতি | কাবার পথে', metaDescription: 'আমরা কীভাবে আপনার ব্যক্তিগত তথ্য সংগ্রহ, ব্যবহার ও সুরক্ষিত রাখি তা জানুন।', keywords: [] },
  { pageKey: 'terms', pagePath: '/terms', pageName: 'Terms & Conditions', title: 'শর্তাবলী | কাবার পথে', metaDescription: 'আমাদের সেবা ব্যবহারের শর্তাবলী, বুকিং নীতি ও দায়বদ্ধতা।', keywords: [] },
]
...
async function seedSEODefaults() {
  await prisma.globalSEO.upsert({
    where: { key: 'global' },
    update: {},
    create: { key: 'global', ...DEFAULT_GLOBAL_SEO },
  })
  ...
  for (const p of STATIC_PAGES) {
    const existing = await prisma.pageSEO.findFirst({
      where: { pageKey: p.pageKey, locale: DEFAULT_LOCALE },
    })
    if (existing) {
      skipped++
      continue
  ...
  console.log(`  SEO defaults: global upserted, pages ${created} created, ${skipped} skipped`)
}
